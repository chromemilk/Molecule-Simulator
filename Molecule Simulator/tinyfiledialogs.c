	...
	int const aDefaultButton ) /* 0 for cancel/no , 1 for ok/yes , 2 for no in yesnocancel */
{
		...
		&& (!getenv( "SSH_CLIENT" ) || getenv( "DISPLAY" )))
	{
		...
		{
			strcpy( tinyfd_response, "windows" ); return 1;
		}
		if (tinyfd_winUtf8)
		{
		...
		if (dialogPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "dialog" ); return 0;
			}
		...
		else
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "basicinput" ); return 0;
			}
	...
	char const *const aDefaultInput ) /* "" , if NULL it's a passwordBox */
{
		...
		&& (!getenv( "SSH_CLIENT" ) || getenv( "DISPLAY" )))
	{
		if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
		{
			strcpy( tinyfd_response, "windows" ); return (char const *)1;
		}
		lBuff[ 0 ] = '\0';
		...
		if (dialogPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "dialog" ); return (char const *)0;
			}
			lBuff[ 0 ] = '\0';
		...
		else
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "basicinput" ); return (char const *)0;
			}
			lBuff[ 0 ] = '\0';
			if (!gWarningDisplayed && !tinyfd_forceConsole)
			{
	...
	int const aDefaultButton ) /* 0 for cancel/no , 1 for ok/yes , 2 for no in yesnocancel */
{
	...
	if (osascriptPresent())
	{
		if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
		{
			strcpy( tinyfd_response, "applescript" ); return 1;
		}
	...
	else if (zenityPresent() || matedialogPresent() || qarmaPresent())
	{
		if (zenityPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "zenity" ); return 1;
			}
		...
		else if (matedialogPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "matedialog" ); return 1;
			}
		...
		else
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "qarma" ); return 1;
			}
	...
	else if (kdialogPresent())
	{
		if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
		{
			strcpy( tinyfd_response, "kdialog" ); return 1;
		}
	...
	else if (!gxmessagePresent() && !gmessagePresent() && !gdialogPresent() && !xdialogPresent() && tkinter2Present())
	{
		if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
		{
			strcpy( tinyfd_response, "tkinter" ); return 1;
		}
...
if res is False :\n\tprint 0\n\
	...
	else if (gxmessagePresent() || gmessagePresent() || (!gdialogPresent() && !xdialogPresent() && xmessagePresent()))
	{
		if (gxmessagePresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "gxmessage" ); return 1;
			}
		...
		else if (gmessagePresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "gmessage" ); return 1;
			}
		...
		else
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "xmessage" ); return 1;
			}
	...
	else if (xdialogPresent() || gdialogPresent() || dialogName() || whiptailPresent())
	{
		if (gdialogPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "gdialog" ); return 1;
			}
			lWasGraphicDialog = 1;
		...
		else if (xdialogPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "xdialog" ); return 1;
			}
			lWasGraphicDialog = 1;
		...
		else if (isTerminalRunning())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "whiptail" ); return 0;
			}
...
tinyfdRes=$(cat /tmp/tinyfd.txt);echo $tinyfdBool$tinyfdRes" );
	...
	else if (!isTerminalRunning() && notifysendPresent() && !strcmp( "ok", aDialogType ))
	{
		if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
		{
			strcpy( tinyfd_response, "notify" ); return 1;
		}
	...
	char const *const aDefaultInput ) /* "" , if NULL it's a passwordBox */
{
	...
	else if (zenityPresent() || matedialogPresent() || qarmaPresent())
	{
		if (zenityPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "zenity" ); return (char const *)1;
			}
		...
		else if (matedialogPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "matedialog" ); return (char const *)1;
			}
		...
		else
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "qarma" ); return (char const *)1;
			}
	...
	else if (kdialogPresent())
	{
		if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
		{
			strcpy( tinyfd_response, "kdialog" ); return (char const *)1;
		}
	...
	else if (gxmessagePresent() || gmessagePresent())
	{
		if (gxmessagePresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "gxmessage" ); return (char const *)1;
			}
		...
		else
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "gmessage" ); return (char const *)1;
			}
	...
	else if (!gdialogPresent() && tkinter2Present())
	{
		if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
		{
			strcpy( tinyfd_response, "tkinter" ); return (char const *)1;
		}
		strcpy( lDialogString, gPython2Name );
		if (!isTerminalRunning() && isDarwin())
		{
...
frontmost of process \\\"Python\\\" to true' ''');" );
		...
		|| dialogName() || whiptailPresent())
	{
		if (gdialogPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "gdialog" ); return (char const *)1;
			}
			lWasGraphicDialog = 1;
			lWasGdialog = 1;
			strcpy( lDialogString, "(gdialog " );
		...
		else if (xdialogPresent())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "xdialog" ); return (char const *)1;
			}
			lWasGraphicDialog = 1;
			strcpy( lDialogString, "(Xdialog " );
		}
		...
		else if (isTerminalRunning())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "whiptail" ); return (char const *)0;
			}
			strcpy( lDialogString, "(whiptail " );
		}
		else
...
to set mycolor to choose color default color {" );
	...
	else if (zenity3Present() || matedialogPresent() || qarmaPresent())
	{
		...
		if (zenity3Present())
		{
			if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
			{
				strcpy( tinyfd_response, "zenity3" ); return (char const *)1;
			}
			sprintf( lDialogString,
	...
	/* {"Row1 Col1","Row1 Col2","Row2 Col1","Row2 Col2"} */
{
	...
	else
	{
		if (aTitle && !strcmp( aTitle, "tinyfd_query" ))
		{
			strcpy( tinyfd_response, "" ); return (char const *)0;
		}
		return NULL;
	}
